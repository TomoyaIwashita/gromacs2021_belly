...
public:
    ...
    std::vector<t_filenm> filenames = { { { efTPR, nullptr, nullptr, ffREAD },
                                          ...
                                          { efTRR, "-readcf", "cf", ffOPTRD },
                                          { efTRR, "-writers", "rs", ffOPTWR } } };
    ...
    t_pargs pa[51] = {
        ...
        { "-nstepsinner",
          FALSE,
          etINT64,
          { &mdrunOptions.numStepslinner },
          "Number of inner steps when using -readcf option." },
	{ "-qfacter",
          FALSE,
          etINT,
          { &mdrunOptions.qfacter },
          "Facter of quasi-simulation." },
        { "-ncfskip",
          FALSE,
          etINT,
          { &mdrunOptions.ncfskip },
          "the number of skip cf data" },
        { "-maxh",
          FALSE,
          etREAL,
